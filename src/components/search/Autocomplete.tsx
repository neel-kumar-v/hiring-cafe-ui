...
function DesktopDropdown({
	...
	return (
		<div
			className="absolute z-50 hidden h-[361px] w-full overflow-visible rounded-b-md border border-gray-200 bg-white shadow-lg md:flex dark:border-gray-600 dark:bg-gray-800"
		...
		>
			...
			{/* Filters section */}
			{showFilters && (
				<div className="relative w-1/2 overflow-y-hidden border-gray-200 border-l dark:border-gray-600">
					<div className="p-3">
						<SearchFilters />
					</div>
				</div>
			...
			<UniversalTooltip content={showFilters ? "Hide filters" : "Show filters"}>
				{showFilters ? (
					<EyeOff
						className="absolute right-3 bottom-3 z-10 h-4 w-4 cursor-pointer text-gray-400 transition-all hover:text-pink-500"
...
function MobileHeader({
	...
	return (
		<div className="flex flex-shrink-0 items-center gap-3 border-gray-200 border-b p-4 dark:border-gray-700">
			<button
			...
			<div className="relative flex-1">
				<input
					autoFocus
					className="w-full rounded-md border border-gray-200 bg-gray-50 px-3 py-2 pl-10 text-gray-900 focus:outline-none focus:ring-2 focus:ring-pink-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
...
function MobileOverlay({
	...
	return (
		<div
			className="fixed inset-0 z-50 flex flex-col bg-white md:hidden dark:bg-gray-900"
	...
	return (
		<>
			<div className="relative">
				<input
					className={`w-full rounded-md border border-gray-200 bg-gray-50 px-3 py-2 pl-10 text-gray-900 transition-all duration-200 ease-in-out focus:rounded-b-none focus:border-gray-200 focus:outline-none focus:ring-0 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:focus:border-gray-600 dark:hover:border-pink-500 ${className}`}
