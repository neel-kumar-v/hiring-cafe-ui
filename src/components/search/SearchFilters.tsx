		...
		<>
			...
			>
				{filterTags.map((tag, index) => (
					<Badge
						className="cursor-pointer rounded-sm border-gray-300 bg-white text-gray-700 transition-all duration-300 hover:bg-gray-100 lg:text-md 2xl:text-lg dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
						key={index}
