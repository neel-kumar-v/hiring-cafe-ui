...
const wrapperBase = "pt-4 rounded-2xl border-2 border-border transition-all duration-500 ease-in-out dark:border-border";
  ...
  return (
    ...
    >
      <div className={cn("space-y-4", edited && categoryId ? "pb-14" : undefined)}>
        <div className="sticky top-0 z-20 -mt-4 rounded-2xl bg-background px-4 pb-3 pt-4">
