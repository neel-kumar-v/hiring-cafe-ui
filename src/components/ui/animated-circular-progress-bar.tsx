...
export function AnimatedCircularProgressBar({ max = 100, min = 0, value = 0, gaugePrimaryColor, gaugeSecondaryColor, className, textClassName }: AnimatedCircularProgressBarProps) {
  ...
  return (
    ...
    >
      ...
      <span
        ...
        className={cn("duration-[var(--transition-length)] delay-[var(--delay)] absolute inset-0 m-auto size-fit ease-linear animate-in fade-in", textClassName)}
      >
        {currentPercent}
      </span>
    </div>
