  ...
  "cursor-pointer inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm outline-none transition-all disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        dashed: "border border-dashed border-border bg-transparent text-muted-foreground shadow-none hover:border-primary/30 hover:bg-accent hover:text-foreground",
        brandOutline: "border border-primary/40 bg-background text-primary shadow-xs hover:border-primary hover:bg-primary hover:text-primary-foreground",
        tab: "border border-border bg-background text-muted-foreground shadow-none hover:bg-accent hover:text-foreground data-[active=true]:border-primary/50 data-[active=true]:bg-brand-soft data-[active=true]:text-primary",
        sidebar:
        ...
        dialogHero: "w-full bg-primary/10 text-foreground shadow-none hover:bg-primary/15 sm:rounded-none sm:border-y sm:border-border sm:bg-transparent sm:hover:bg-transparent",
      },
      size: {
