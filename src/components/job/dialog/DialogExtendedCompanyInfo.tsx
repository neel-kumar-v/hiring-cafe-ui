...
export default function DialogExtendedCompanyInfo({
  companyData,
}: {
    ...
    <ul className="flex flex-col gap-2 py-2 pt-4 text-sm md:text-base">
      ...
      {companyData.num_employees && (
        <InfoListItem
          icon={Users}
          header="Employees"
          value={companyData.num_employees.toLocaleString()}
        />
      )}
      {companyData.headquarters_country && (
        <InfoListItem
          icon={Globe}
          header="Company Headquarters Location"
      ...
      {companyData.latest_investment_year && (
        <InfoListItem
          icon={Calendar}
          header="Latest Investment Year"
          value={companyData.latest_investment_year}
        />
      )}
      {companyData.latest_investment_series && (
        <InfoListItem
          icon={BadgeDollarSign}
          header="Investment Series"
          value={companyData.latest_investment_series}
        />
      )}
      {companyData.linkedin_url && (
        <InfoListItem
          ...
          value={
            <a
              ...
              className="underline text-pink-700 dark:text-pink-300"
            >
