...
const CardNavigation = ({
	...
	return (
		<div className="flex cursor-pointer items-center justify-center space-x-1 px-2">
			{/* Left Chevron */}
			<div
				className={`flex h-6 w-6 cursor-pointer items-center justify-center rounded-full p-0 text-gray-500 transition-all duration-200 ease-in-out hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200 ${
					totalJobs <= 1 ||
