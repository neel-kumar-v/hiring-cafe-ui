...
export default function SearchDialog({
					...
					<div className="space-y-4">
						...
						<div className="space-y-4">
							<div className="flex items-center space-x-2">
								<input
									className="w-16 rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
									placeholder="3"
									type="number"
								/>
								<select className="rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
					...
					<div className="space-y-4">
						...
						<div className="space-y-4">
							<div>
								...
								<select className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
	...
	const renderSidebar = () => (
		<div className="w-[30%] overflow-y-auto border-gray-200 border-r bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
		...
		return (
			<Drawer onOpenChange={onOpenChange} open={open}>
				<DrawerContent className="max-h-[90vh] min-h-[60vh] overflow-y-auto">
					<DrawerHeader className="border-gray-200 border-b px-6 py-4 dark:border-gray-700">
	...
	return (
		<Dialog onOpenChange={onOpenChange} open={open}>
			<DialogContent
				className={`h-[90vh] w-[800px] min-w-[80vw] max-w-[90vw] border border-gray-100 bg-white p-0 dark:border-gray-700 dark:bg-gray-800 ${
					isDarkMode ? "dark" : ""
				}`}
			>
				<DialogHeader className="border-gray-200 border-b px-6 py-4 dark:border-gray-700">
				...
				<DialogFooter className="border-gray-200 border-t px-6 py-4 dark:border-gray-700">
					<Button onClick={() => onOpenChange(false)} variant="outline">
						Cancel
					</Button>
