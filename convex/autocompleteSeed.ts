...
async function upsertValueAndLink(ctx: MutationCtx, type: AutocompleteType, value: string): Promise<{ createdNewAssociation: boolean }> {
...
export const seedBatch = mutation({
  ...
  handler: async (ctx, { adminSecret, type, start, count }) => {
